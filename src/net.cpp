...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cointest " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cointesttools.com", "dnsseed.cointesttools.com"},
    {"cointestpool.org", "dnsseed.cointestpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"cointesttools.com", "testnet-seed.cointesttools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cointest is probably already running."), addrBind.ToString().c_str());
        else
